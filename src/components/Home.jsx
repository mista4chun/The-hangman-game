...
function Home() {
  return (
    <div className="flex relative  h-screen items-center justify-center z-20">
      <div className="relative flex h-[500px] w-[592px] flex-col items-center justify-center rounded-[4rem] bg-linear-to-bl from-[#344ABA] to-[#001479] opacity-90 shadow-[inset_0px_-8px_0px_4px_#140E66,inset_0px_6px_0px_8px_#2463FF]">
        ...
        <Link
          to="/how-to-play"
          className="font-mouse w-56 rounded-full bg-[#2463FF] px-6 py-3 text-center text-3xl text-white uppercase shadow-[inset_0px_4px_0px_2px_#507ef5,inset_0px_-2px_0px_2px_#140E66]"
        >
          how to Play
        </Link>
      </div>
